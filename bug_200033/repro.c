...
*(uint32_t*)0x200013d0 = htobe32(0x401);
...
*(uint8_t*)0x20001498 = 5;
*(uint8_t*)0x20001499 = 1;
*(uint8_t*)0x2000149a = 0;
*(uint32_t*)0x2000149c = 0;
*(uint32_t*)0x200014a0 = 0;
*(uint32_t*)0x200014a4 = 0;
	syscall(__NR_setsockopt, r[1], 0, 0x11, 0x200013c0, 0xe8);
...
*(uint8_t*)0x2000154f = 0;
	syscall(__NR_sendto, r[2], 0x200014c0, 0, 0, 0x20001540, 0x10);
}
